...
echo "################ benchの実行 ####################"
ansible -i inventory/inventory.yml isu14_bench -b --become-user isucon -a "/home/isucon/bench_linux_amd64 run --target=https://172.27.16.3 --payment-url=http://192.168.37.131:12345" | tee ../../result/bench_result/bench_`date +%Y%m%d%H%M`.log 
